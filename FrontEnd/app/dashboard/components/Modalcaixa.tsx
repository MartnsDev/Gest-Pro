...
export default function ModalCaixa({
  ...
  const abrirCaixa = async () => {
    ...
    const val = Number.parseFloat(saldoInicial.replace(",", "."));
  ...
  const fecharCaixa = async () => {
    ...
    const val = Number.parseFloat(saldoFinal.replace(",", "."));
    if (Number.isNaN(val) || val < 0) {
      setErro("Informe o saldo final em caixa.");
      return;
    }
    setLoading(true);
    setErro("");
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  fontSize: 13,
                  fontWeight: 600,
                  cursor: empresaSel ? "pointer" : "not-allowed",
                  opacity: empresaSel ? 1 : 0.5,
                }}
              >
                Continuar
              </button>
