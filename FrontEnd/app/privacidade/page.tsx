          ...
          <div className={`${styles.glass}`} style={{ padding: "40px 36px", borderRadius: 20 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
              ...
              <section>
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  <p style={{ marginBottom: 16 }}>
                    A sua privacidade e importante para nos. Esta Politica de Privacidade explica como o GestPro coleta, usa, divulga e protege suas informacoes pessoais quando voce utiliza nossa plataforma de gestao comercial.
                  </p>
                  <p>
                    Nos comprometemos a proteger sua privacidade e a tratar seus dados pessoais em conformidade com a Lei Geral de Protecao de Dados (LGPD - Lei n. 13.709/2018) e demais legislacoes aplicaveis.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  <p style={{ marginBottom: 16 }}><strong style={{ color: "#f1f5f9" }}>Dados de Cadastro:</strong></p>
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
                    {["Nome completo", "Endereco de e-mail", "Numero de telefone", "CPF/CNPJ", "Endereco comercial"].map((item) => (
                  ...
                  <p style={{ marginBottom: 16 }}><strong style={{ color: "#f1f5f9" }}>Dados de Uso:</strong></p>
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10, marginBottom: 20 }}>
                    {["Informacoes de vendas e transacoes", "Dados de produtos e estoque", "Informacoes de clientes cadastrados", "Registros de caixa e pagamentos", "Logs de acesso ao sistema"].map((item) => (
                      <li key={item} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          <polyline points="20 6 9 17 4 12" />
                        </svg>
                  ...
                  <p style={{ marginBottom: 16 }}><strong style={{ color: "#f1f5f9" }}>Dados Tecnicos:</strong></p>
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 10 }}>
                    {["Endereco IP", "Tipo de navegador e dispositivo", "Sistema operacional", "Paginas visitadas e tempo de permanencia", "Cookies e tecnologias similares"].map((item) => (
                      <li key={item} style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                          <polyline points="20 6 9 17 4 12" />
                        </svg>
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  <p style={{ marginBottom: 16 }}>Utilizamos seus dados pessoais para:</p>
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                    {[
                      ...
                      <li key={item} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginTop: 4, flexShrink: 0 }}>
                          <polyline points="20 6 9 17 4 12" />
                        </svg>
                        {item}
                      </li>
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  <p style={{ marginBottom: 16 }}>
                    <strong style={{ color: "#10b981" }}>Nao vendemos seus dados pessoais.</strong> Podemos compartilhar suas informacoes apenas nas seguintes situacoes:
                  </p>
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                    {[
                      { title: "Prestadores de servico", desc: "Empresas que nos ajudam a operar a plataforma (hospedagem, pagamentos, e-mail)" },
                      { title: "Obrigacoes legais", desc: "Quando exigido por lei, ordem judicial ou autoridade competente" },
                      { title: "Protecao de direitos", desc: "Para proteger nossos direitos, privacidade, seguranca ou propriedade" },
                      { title: "Com seu consentimento", desc: "Em outras situacoes, sempre com sua autorizacao previa" }
                    ].map((item) => (
                      <li key={item.title} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                        ...
                        <div>
                          <strong style={{ color: "#f1f5f9" }}>{item.title}:</strong> {item.desc}
                        </div>
                      </li>
                    ))}
                  </ul>
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 16 }}>
                    {[
                      { icon: "🔒", title: "Criptografia", desc: "Dados em transito e em repouso" },
                      { icon: "🛡️", title: "Firewall", desc: "Protecao contra ataques externos" },
                      { icon: "🔐", title: "Autenticacao", desc: "Acesso seguro com 2FA opcional" },
                      { icon: "💾", title: "Backups", desc: "Copias de seguranca diarias" }
                    ].map((item) => (
                      <div key={item.title} style={{ background: "rgba(16,185,129,0.05)", border: "1px solid rgba(16,185,129,0.1)", borderRadius: 12, padding: 16 }}>
                        <div style={{ fontSize: 24, marginBottom: 8 }}>{item.icon}</div>
                        <div style={{ fontWeight: 600, color: "#f1f5f9", marginBottom: 4 }}>{item.title}</div>
                        <div style={{ fontSize: 13, color: "rgba(241,245,249,0.5)" }}>{item.desc}</div>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  ...
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                    {[
                      { title: "Acesso", desc: "Solicitar copia dos seus dados pessoais" },
                      { title: "Correcao", desc: "Corrigir dados incompletos ou desatualizados" },
                      { title: "Exclusao", desc: "Solicitar a exclusao dos seus dados" },
                      { title: "Portabilidade", desc: "Receber seus dados em formato estruturado" },
                      { title: "Revogacao", desc: "Retirar consentimento a qualquer momento" },
                      { title: "Informacao", desc: "Saber com quem seus dados foram compartilhados" }
                    ].map((item) => (
                      <li key={item.title} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginTop: 4, flexShrink: 0 }}>
                          <polyline points="20 6 9 17 4 12" />
                  ...
                  <p style={{ marginTop: 20, padding: 16, background: "rgba(16,185,129,0.05)", borderRadius: 12, border: "1px solid rgba(16,185,129,0.15)" }}>
                    Para exercer seus direitos, entre em contato pelo e-mail <strong style={{ color: "#10b981" }}>privacidade@gestpro.com.br</strong>
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  ...
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                    {[
                      { title: "Essenciais", desc: "Necessarios para o funcionamento da plataforma" },
                      { title: "Funcionais", desc: "Lembram suas preferencias e configuracoes" },
                      { title: "Analiticos", desc: "Nos ajudam a entender como voce usa o sistema" },
                      { title: "Marketing", desc: "Permitem campanhas personalizadas (com seu consentimento)" }
                    ].map((item) => (
                      <li key={item.title} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ marginTop: 4, flexShrink: 0 }}>
                          <polyline points="20 6 9 17 4 12" />
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  <p style={{ marginBottom: 16 }}>
                    Mantemos seus dados pessoais pelo tempo necessario para cumprir as finalidades descritas nesta politica:
                  </p>
                  <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 12 }}>
                    {[
              ...
              <section>
                ...
                <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 15, color: "rgba(241,245,249,0.7)", lineHeight: 1.8 }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 12, padding: 20, background: "rgba(16,185,129,0.05)", borderRadius: 12, border: "1px solid rgba(16,185,129,0.15)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <circle cx="12" cy="12" r="10" /><path d="M12 16v-4" /><path d="M12 8h.01" />
                      </svg>
                      <strong style={{ color: "#f1f5f9" }}>Encarregado de Dados (DPO)</strong>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContainer}>
          ...
          <div className={styles.footerLinks}>
            ...
            <Link href="/privacidade" className={`${styles.footerLink} ${styles.footerLinkActive}`}>Privacidade</Link>
