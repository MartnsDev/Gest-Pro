...
const Logo = ({ size = "default" }: { size?: "default" | "small" }) => {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, cursor: "pointer" }}>
      ...
      />
      <span style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 800, fontSize, color: "#f1f5f9", letterSpacing: "-0.02em" }}>
    ...
    <>
      <nav style={{
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 28px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 36 }} className="desktop-nav">
            {links.map(l => (
              <a key={l} href={`#${l.toLowerCase().replace(" ", "-")}`} style={{
                fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 14, fontWeight: 500,
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <button className="btn-ghost desktop-nav" onClick={onLogin} style={{ padding: "9px 20px", fontSize: 14 }}>Entrar</button>
            <button className="btn-green desktop-nav" onClick={onRegister} style={{ padding: "9px 20px", fontSize: 14 }}>Começar grátis</button>
      ...
      {menuOpen && (
        <div className="mob-menu" onClick={() => setMenuOpen(false)}>
          <button onClick={() => setMenuOpen(false)} style={{ position: "absolute", top: 24, right: 24, background: "none", border: "none", color: "#f1f5f9", fontSize: 28, cursor: "pointer" }}>
          ...
          {links.map(l => (
            <a key={l} href={`#${l.toLowerCase()}`}
              style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontSize: 28, fontWeight: 700, color: "#f1f5f9", textDecoration: "none" }}
            >{l}</a>
          ))}
  ...
  <div className="dash-float" style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        fontFamily: "var(--font-dm-mono), 'DM Mono', monospace", fontSize: 10, color: "rgba(255,255,255,0.3)",
    ...
    <div style={{ display: "flex", alignItems: "center", gap: 40, width: "100%", flexWrap: "wrap" }}>
      <div style={{ flex: "1 1 320px", minWidth: 0 }}>
        <div className="fade-up d1" style={{
          ...
          fontFamily: "var(--font-dm-mono), 'DM Mono', monospace", fontSize: 11, color: "#10b981",
        ...
        <h1 className="fade-up d2 hero-text" style={{
        ...
        <p className="fade-up d3 hero-sub" style={{
          fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontWeight: 400,
          fontSize: "clamp(14px, 3vw, 17px)", lineHeight: 1.7, color: "rgba(241,245,249,0.6)",
        ...
        <div className="fade-up d5" style={{ marginTop: 40, display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ display: "flex" }}>
            {["#10b981","#34d399","#6ee7b7","#a7f3d0","#d1fae5"].map((c, i) => (
              <div key={i} style={{
                ...
                fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, color: "#fff",
              }}>
                {["M","J","A","R","L"][i]}
              </div>
            ))}
          ...
          <div>
            <div style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, fontSize: 14, color: "#f1f5f9" }}>+2.400 lojistas</div>
            <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 12, color: "rgba(241,245,249,0.45)" }}>já usam o GestPro</div>
          </div>
        </div>
      </div>

      <div className="fade-in d3" style={{ flex: "1 1 300px", display: "flex", justifyContent: "center", position: "relative", minWidth: 0, width: "100%" }}>
      ...
      <div style={{
        ...
        {stats.map((s, i) => (
          <div key={i} className="hover-lift" style={{
            ...
            <div style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 800, fontSize: 36, color: "#10b981", letterSpacing: "-0.03em", marginBottom: 6 }}>{s.value}</div>
            <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 13, color: "rgba(241,245,249,0.45)", fontWeight: 400 }}>{s.label}</div>
          </div>
        ))}
      </div>
    </section>
...
const Features = () => {
  const feats = [
    { icon: "💰", title: "Controle de Caixa", desc: "Abra e feche caixas com saldo inicial, acompanhe cada centavo em tempo real com total transparência.", tag: "Financeiro" },
    { icon: "📦", title: "Gestão de Estoque", desc: "Monitore produtos, receba alertas de estoque zero e nunca perca uma venda por falta de produto.", tag: "Estoque" },
    { icon: "📊", title: "Relatórios Completos", desc: "Exporte em CSV, HTML ou PDF. Visualize por período, por caixa ou produto com gráficos detalhados.", tag: "Analytics" },
    { icon: "💳", title: "Multi Pagamentos", desc: "PIX, Dinheiro, Débito e Crédito. Registre tudo e veja a distribuição por forma de pagamento.", tag: "Pagamentos" },
    { icon: "👥", title: "Gestão de Clientes", desc: "Cadastre clientes, acompanhe histórico de compras e construa relacionamentos duradouros.", tag: "CRM" },
    { icon: "🏢", title: "Multi Empresa", desc: "Gerencie várias filiais ou negócios em uma única conta. Troque com um clique.", tag: "Empresas" },
  ];
          ...
          {feats.map((f, i) => (
            ...
            >
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 16 }}>
                ...
                <span style={{
                  fontFamily: "var(--font-dm-mono), 'DM Mono', monospace", fontSize: 10, color: "#10b981",
                  background: "rgba(16,185,129,0.1)", border: "1px solid rgba(16,185,129,0.2)",
                  padding: "3px 10px", borderRadius: 99, letterSpacing: ".08em",
                }}>{f.tag}</span>
              </div>
              <h3 style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, fontSize: 19, color: "#f1f5f9", marginBottom: 10 }}>{f.title}</h3>
              <p style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 14, color: "rgba(241,245,249,0.5)", lineHeight: 1.7 }}>{f.desc}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 24, position: "relative" }}>
          ...
          {steps.map((s, i) => (
            <div key={i} style={{ textAlign: "center", position: "relative", zIndex: 1 }}>
              ...
              <div style={{ fontFamily: "var(--font-dm-mono), 'DM Mono', monospace", fontSize: 10, color: "#10b981", letterSpacing: ".12em", marginBottom: 8 }}>{s.n}</div>
              <h3 style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, fontSize: 18, color: "#f1f5f9", marginBottom: 8 }}>{s.title}</h3>
              <p style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 13, color: "rgba(241,245,249,0.5)", lineHeight: 1.65 }}>{s.desc}</p>
            </div>
          ))}
        </div>
      </div>
...
const Plans = ({ onRegister }: PlansProps) => {
  const plans = [
    ...
    {
      name: "Basico", price: "R$ 29,90", period: "por mes",
      desc: "Ideal para pequenos negocios",
      features: ["1 empresa / loja", "1 caixa", "Dashboard completo", "Relatorios basicos", "Suporte por e-mail"],
      cta: "Assinar Basico", popular: false, icon: "star", color: "#f1f5f9",
    },
    {
      name: "Pro", price: "R$ 49,90", period: "por mes",
      desc: "Para negocios em crescimento",
      features: ["5 empresas / lojas", "3 caixas por empresa", "Dashboard avancado", "Relatorios completos", "Suporte prioritario"],
      cta: "Assinar Pro", popular: true, icon: "rocket", color: "#10b981",
    },
    {
      name: "Premium", price: "R$ 99,90", period: "por mes",
      desc: "Para redes e franquias",
      features: ["Empresas ilimitadas", "Caixas ilimitados", "Dashboard completo", "Relatorios avancados", "Suporte dedicado 24h"],
      cta: "Assinar Premium", popular: false, icon: "crown", color: "#f59e0b",
    },
  ];
    ...
    <section id="planos" style={{ position: "relative", zIndex: 10, padding: "80px 28px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 64 }}>
          ...
          <h2 className="section-heading" style={{ fontSize: "clamp(32px,4vw,52px)", marginBottom: 16 }}>
            Preco justo,<br />valor real
          </h2>
          <p className="section-sub" style={{ fontSize: 16 }}>Comece gratis. Escale quando quiser.</p>
        </div>
        ...
        <div className="plans-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16, alignItems: "stretch" }}>
          {plans.map((p, i) => (
            <div key={i}
              ...
              style={{ padding: "28px 24px", position: "relative", display: "flex", flexDirection: "column" }}
            >
              {p.popular && (
                <div style={{
                  ...
                  fontFamily: "var(--font-dm-mono), 'DM Mono', monospace", fontSize: 10, color: "#fff", letterSpacing: ".1em",
                  whiteSpace: "nowrap",
                }}>MAIS POPULAR</div>
              )}
              ...
              <div style={{ marginBottom: 4, fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, fontSize: 18, color: "#f1f5f9" }}>{p.name}</div>
              <p style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 12, color: "rgba(241,245,249,0.45)", marginBottom: 16, lineHeight: 1.5 }}>{p.desc}</p>
              
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                <span style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 800, fontSize: p.price === "Gratis" ? 28 : 26, color: p.popular ? "#10b981" : "#f1f5f9" }}>{p.price}</span>
              </div>
              <span style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 12, color: "rgba(241,245,249,0.4)", marginBottom: 20 }}>{p.period}</span>
              
              <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 24, flex: 1 }}>
                {p.features.map(f => (
                  <div key={f} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                    <span style={{ color: "#10b981", fontSize: 14, marginTop: 1 }}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                        <polyline points="20 6 9 17 4 12"/>
                      </svg>
                    </span>
                    <span style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 13, color: "rgba(241,245,249,0.65)" }}>{f}</span>
                  </div>
                ))}
              </div>
              <button
                ...
                onClick={onRegister}
                style={{ width: "100%", padding: "12px", fontSize: 14, borderRadius: 10, marginTop: "auto" }}
              >{p.cta}</button>
            </div>
          ))}
        </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(300px, 1fr))", gap: 18 }}>
          {quotes.map((q, i) => (
            <div key={i} className="glass hover-lift" style={{ padding: "28px 24px" }}>
              <div style={{ fontSize: 24, color: "#10b981", marginBottom: 14, fontFamily: "var(--font-syne), 'Syne', sans-serif" }}>"</div>
              <p style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 14, color: "rgba(241,245,249,0.65)", lineHeight: 1.75, marginBottom: 20 }}>{q.text}</p>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <div style={{
                  width: 38, height: 38, borderRadius: "50%",
                  background: "linear-gradient(135deg, #10b981, #059669)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, fontSize: 14, color: "#fff",
                }}>{q.name[0]}</div>
                <div>
                  <div style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 700, fontSize: 13, color: "#f1f5f9" }}>{q.name}</div>
                  <div style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 11, color: "rgba(241,245,249,0.35)" }}>{q.role}</div>
                </div>
              </div>
            </div>
          ))}
  ...
  <section style={{ position: "relative", zIndex: 10, padding: "80px 28px 100px" }}>
    <div style={{ maxWidth: 800, margin: "0 auto", textAlign: "center" }}>
      <div className="glass-bright" style={{ padding: "64px 48px", borderRadius: 24, position: "relative", overflow: "hidden" }}>
        ...
        <p style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 12, color: "rgba(241,245,249,0.3)", marginTop: 20 }}>
  ...
  return (
    <footer style={{
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 16 }}>
        <Logo size="small" />
        <p style={{ fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 12, color: "rgba(241,245,249,0.3)" }}>
          {new Date().getFullYear()} GestPro - Todos os direitos reservados
        </p>
        <div className="footer-links" style={{ display: "flex", gap: 24 }}>
          {links.map(l => (
            <a key={l.label} href={l.href} style={{
              fontFamily: "var(--font-manrope), 'Manrope', sans-serif", fontSize: 12,
              color: l.label === "Como usar" ? "#10b981" : "rgba(241,245,249,0.35)", 
              textDecoration: "none",
              transition: "color .2s",
              fontWeight: l.label === "Como usar" ? 600 : 400,
            }}
              onMouseEnter={e => (e.currentTarget.style.color = "#10b981")}
              onMouseLeave={e => (e.currentTarget.style.color = l.label === "Como usar" ? "#10b981" : "rgba(241,245,249,0.35)")}
            >{l.label}</a>
          ))}
        </div>
      </div>
