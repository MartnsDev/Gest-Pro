            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 40 }}>
              ...
              <section>
                ...
                >
                  ...
                  >
                    {[
                      "Controle de caixa e vendas em tempo real",
                      "Gestao de estoque e produtos",
                      "Cadastro e acompanhamento de clientes",
                      "Relatorios financeiros e gerenciais",
                      "Multi empresa / filiais",
                      "Exportacao de dados em diversos formatos",
                    ].map((item) => (
                      <li
                        key={item}
                        style={{
                ...
                >
                  ...
                  >
                    {[
                      ...
                      "Fornecer informacoes verdadeiras e completas no cadastro",
                      "Manter suas credenciais de acesso em sigilo",
                      "Ser responsavel por todas as atividades em sua conta",
                      "Notificar imediatamente sobre uso nao autorizado",
                    ].map((item) => (
                      <li
                        key={item}
                        style={{
              ...
              <section>
                ...
                >
                  ...
                  >
                    {[
                      "A cobranca sera recorrente conforme o ciclo do plano escolhido",
                      "O periodo de teste gratuito de 30 dias e oferecido apenas uma vez por usuario",
                      "O cancelamento pode ser feito a qualquer momento, sem multa",
                      "Nao ha reembolso para periodos parciais ja pagos",
                      "Os precos podem ser alterados com aviso previo de 30 dias",
                    ].map((item) => (
                      <li
                        key={item}
                        style={{
                ...
                >
                  ...
                  >
                    {[
                      ...
                      "Transmitir virus ou codigos maliciosos",
                      "Tentar acessar sistemas ou dados de outros usuarios",
                      "Realizar engenharia reversa do software",
                      "Revender ou redistribuir o servico sem autorizacao",
                    ].map((item) => (
                      <li
                        key={item}
                        style={{
                ...
                >
                  ...
                  >
                    {[
                      ...
                      "Interrupcoes de servico fora de nosso controle",
                      "Decisoes de negocios baseadas nos dados do sistema",
                    ].map((item) => (
                      <li
                        key={item}
                        style={{
              ...
              <section>
                ...
                >
                  <p style={{ marginBottom: 16 }}>
                    ...
                    configuracoes do sistema ou entrando em contato com nosso
                    suporte.
                  </p>
                  <p>
                    Apos o cancelamento, seus dados serao mantidos por 30 dias
                    para possivel recuperacao. Apos este periodo, serao
                    permanentemente excluidos de nossos servidores.
                  </p>
                </div>
              </section>
