  ...
  return (
    <div style={{ minHeight: "100vh", background: "#030305", display: "flex", fontFamily: "var(--font-dm-mono), 'DM Mono', monospace", overflowX: "hidden" }}>
      ...
      <div className="login-left-panel" style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <div style={{
            ...
            <p style={{ fontSize: 14, color: "rgba(241,245,249,0.4)", lineHeight: 1.8, maxWidth: 380, fontFamily: "var(--font-manrope), 'Manrope', sans-serif" }}>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={i} style={{ padding: "16px", border: "1px solid rgba(16,185,129,0.1)", borderRadius: 10, background: "rgba(16,185,129,0.03)" }}>
                <div style={{ fontFamily: "var(--font-syne), 'Syne', sans-serif", fontWeight: 800, fontSize: 26, color: "#10b981", letterSpacing: "-0.03em" }}>{s.v}</div>
      ...
      <div className="login-right-panel" style={{
        width: "clamp(320px, 40%, 520px)", display: "flex", alignItems: "center", justifyContent: "center",
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 7 }}>
                ...
                <Link href="/esqueceu-senha" className="link-style" style={{ fontSize: 12 }}>Esqueceu?</Link>
              </div>
